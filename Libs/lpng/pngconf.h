...
#if !defined(MACOS) && !defined(RISCOS) && !defined(_WIN32_WCE) && !defined(__MWERKS__)
#include <sys/types.h>
#endif
...
// @ALEX: read from memory with some ph profiles (at pngset.c, png_set_iCCP, ln 442, png_memcpy)
#define PNG_NO_READ_iCCP
#define PNG_NO_WRITE_iCCP
